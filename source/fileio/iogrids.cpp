...
template void writeGridRaw<Vec3i>(const string& name, Grid<Vec3i>* grid);
...
template void writeGridUni<Vec3i>(const string& name, Grid<Vec3i>* grid);
...
template void writeGridVol<Vec3i>(const string& name, Grid<Vec3i>* grid);
...
template void writeGridTxt<Vec3i>(const string& name, Grid<Vec3i>* grid);
...
template void readGridRaw<Vec3i>(const string& name, Grid<Vec3i>* grid);
...
template void readGridUni<Vec3i>(const string& name, Grid<Vec3i>* grid);
...
template void readGridVol<Vec3i>(const string& name, Grid<Vec3i>* grid);
